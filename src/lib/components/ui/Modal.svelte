...
{#if opened}
  <dialog
    ...
    class = "backdrop:bg-black/30 fixed top-1/2 left-1/2 -translate-1/2"
  >
    <div class="size-fit max-w-full max-h-full border border-black bg-white p-2 gap-4 flex flex-col">
