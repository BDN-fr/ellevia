...
const errorsMessages: Record<string, (range?: { min: string; max: string }) => string> = {
	no_solution: () =>
		"Pas de solution possible pour ce trajet, essayez de modifier la date et l'heure",
	no_destination: () =>
		"La destination n'est pas desservie, essayez de modifier la date et l'heure",
